...
export default function RestaurantCashier({ params }: POSSystemProps) {
  ...
  useEffect(() => {
    fetchDailySales();
    // Start with empty cart - items will be added via voice/programmatically
  }, []);
    ...
    <div className="h-screen flex flex-col bg-gray-50">
      ...
      <div className="flex-1 flex gap-4 p-4 overflow-hidden">
        ...
        <div className="flex-1 bg-white rounded-lg shadow-lg p-4 flex flex-col">
          ...
          <div className="mb-4">
            <button
              onClick={() => addItem('Burger', 1, 18.99)}
              className="w-full bg-blue-500 hover:bg-blue-600 text-white text-2xl font-bold py-4 rounded-lg transition-colors flex items-center justify-center"
            >
              + Add Burger
            </button>
          </div>
